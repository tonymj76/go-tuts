...
// shut down on an operating system interupt
type Runner struct {
	// interrupt channel reports a signal form the
	// operating system
...
func (r *Runner) Start() error {
	// We want to receive all interrupt base signals
	...
	// select helps to return which condition is met
	select {
